...
const nunjucksContext = {
  ...
  CSL_DESCRIPTION: 'Перед вами пилотная версия просветительского портала, работа над которым еще только начинается. Пока что посетителям доступны видеолекции по истории церковнославянского языка и книжности. В ближайшее время появится электронная версия Большого словаря церковнославянского языка Нового времени. Чуть позже — греко-славянский индекс и аннотированный путеводитель по ресурсам Интернета, связанным с церковнославянским языком.',
